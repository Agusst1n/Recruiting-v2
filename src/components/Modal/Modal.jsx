...
const Modal = () => {
  ...
  const pushQuestion = () => {
    ...
    let questionsStateActualizado = questionsState.filter(
  ...
  return (
    <>
      <div
        className={
          modalStatus ? styles.modal_containerON : styles.modal_containerOFF
        }
        onClick={closeModal}
      ></div>
      <div className={modalStatus ? styles.modalON : styles.modalOFF}>
        ...
        <div
          className={
            initialQuestionLength
              ? styles.button_atrasOFF
              : styles.button_atrasON
          }
        >
        ...
        <div
          className={
            recordVideo ? styles.button_siguienteON : styles.button_siguienteOFF
          }
        >
          <button onClick={pushQuestion}>
            {questionStateLength ? 'Enviar' : 'Siguiente'}
          </button>
        </div>
      </div>
    </>
